...
openwifi ships a set of **application notes** in [`openwifi/doc/app_notes/`](https://github.com/open-sdr/openwifi/blob/master/doc/app_notes/README.md): short, task-focused write-ups for specific scenarios and modes. This wiki weaves their material into the thematic pages (Operating Modes, Research Features, sdrctl, and so on), but this page indexes every note in one place.

Each entry below expands to a short summary and the note's key figures. Use **Read in this wiki** to jump to the fuller treatment in context, or **Upstream source** to open the original note on GitHub. The upstream repo is always authoritative.
...
??? note "WiFi CSI radar via self CSI capturing"
    ...
    [Read in this wiki →](Research-Features.md#csi-radar-full-duplex-self-sensing) · [Upstream source ↗](https://github.com/open-sdr/openwifi/blob/master/doc/app_notes/radar-self-csi.md)
...
??? note "CSI fuzzer"
    ...
    [Read in this wiki →](Research-Features.md#csi-fuzzer-privacy-protection) · [Upstream source ↗](https://github.com/open-sdr/openwifi/blob/master/doc/app_notes/csi_fuzzer.md)
...
??? note "Capture IQ sample, AGC gain, RSSI with many trigger conditions"
    ...
    [Read in this wiki →](Research-Features.md#iq-capture) · [Upstream source ↗](https://github.com/open-sdr/openwifi/blob/master/doc/app_notes/iq.md)
...
??? note "ACK timing verification by IQ capture"
    ...
    [Read in this wiki →](Research-Features.md#ack-timing-measurement) · [Upstream source ↗](https://github.com/open-sdr/openwifi/blob/master/doc/app_notes/iq_ack_timing.md)
...
??? note "Access counter/statistics in FPGA"
    ...
    [Read in this wiki →](Research-Features.md#fpga-event-counters) · [Upstream source ↗](https://github.com/open-sdr/openwifi/blob/master/doc/app_notes/perf_counter.md)
...
??? note "Access counter/statistics in driver"
    ...
    [Read in this wiki →](sdrctl-and-Runtime-Control.md#statistics-via-sysfs) · [Upstream source ↗](https://github.com/open-sdr/openwifi/blob/master/doc/app_notes/driver_stat.md)
...
??? note "Build FPGA with High-Level Synthesis modules"
    ...
    [Read in this wiki →](FPGA-Development.md#high-level-synthesis-hls-modules) · [Upstream source ↗](https://github.com/open-sdr/openwifi/blob/master/doc/app_notes/hls.md)
...
??? note "Use openwifi on the w-iLab.t testbed remotely (external)"
    ...
    [Read in this wiki →](Supported-Boards.md#no-hardware-use-the-testbed) · [Tutorial ↗](https://doc.ilabt.imec.be/ilabt/wilab/tutorials/openwifi.html)
